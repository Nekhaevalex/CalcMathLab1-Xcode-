  ...
  public class NumericLab3
  {
    ...
    private void EJL2M(int Fidx)
    {
      ...
      do
      {
        ...
        int num10 = 1;
        int n = this.N;
        for (int index = num10; index <= n; ++index)
        {
          ++num8;
          double X = x0;
          x0 += num5;
    ...
    private void EJL2R(int Fidx)
    {
      ...
      do
      {
        ...
        for (int index = num10; index <= n; ++index)
        {
          ...
          {
            case 3:
              double num11 = this.calcF3(X, Y);
              num4 = Y + num6 * (num11 + this.calcF3(x0, Y + num5 * num11));
              break;
            case 5:
              double num12 = this.calcF5(X, Y);
              num4 = Y + num6 * (num12 + this.calcF5(x0, Y + num5 * num12));
              break;
            case 12:
              double num13 = this.calcF12(X, Y);
              num4 = Y + num6 * (num13 + this.calcF12(x0, Y + num5 * num13));
              break;
            case 16:
              double num14 = this.calcF16(X, Y);
              num4 = Y + num6 * (num14 + this.calcF16(x0, Y + num5 * num14));
              break;
          }
          if (num8 == num7)
          {
    ...
    private void RUNKU3(int Fidx)
    {
      ...
      do
      {
        ...
        int num11 = 1;
        int n = this.N;
        for (int index = num11; index <= n; ++index)
        {
          ++num9;
          double X1 = x0;
          x0 += num5;
          ...
          {
            case 2:
              num12 = this.calcF2(X1, Y);
              num13 = this.calcF2(X2, Y + num12 * num6);
              num14 = this.calcF2(x0, Y + (2.0 * num13 - num12) * num5);
              break;
            case 7:
              num12 = this.calcF7(X1, Y);
              num13 = this.calcF7(X2, Y + num12 * num6);
              num14 = this.calcF7(x0, Y + (2.0 * num13 - num12) * num5);
              break;
            case 9:
              num12 = this.calcF9(X1, Y);
              num13 = this.calcF9(X2, Y + num12 * num6);
              num14 = this.calcF9(x0, Y + (2.0 * num13 - num12) * num5);
              break;
            case 14:
              num12 = this.calcF14(X1, Y);
              num13 = this.calcF14(X2, Y + num12 * num6);
              num14 = this.calcF14(x0, Y + (2.0 * num13 - num12) * num5);
              break;
          }
          num4 = Y + num7 * (num12 + 4.0 * num13 + num14);
          if (num9 == num8)
          {
            num9 = 0;
            ++num10;
    ...
    private void RUNKU4(int Fidx)
    {
      ...
      do
      {
        ...
        for (int index = num11; index <= n; ++index)
        {
          ...
          {
            case 1:
              num12 = this.calcF1(X1, Y);
              num13 = this.calcF1(X2, Y + num12 * num6);
              num14 = this.calcF1(X2, Y + num13 * num6);
              num15 = this.calcF1(x0, Y + num14 * num5);
              break;
            case 8:
              num12 = this.calcF8(X1, Y);
              num13 = this.calcF8(X2, Y + num12 * num6);
              num14 = this.calcF8(X2, Y + num13 * num6);
              num15 = this.calcF8(x0, Y + num14 * num5);
              break;
            case 10:
              num12 = this.calcF10(X1, Y);
              num13 = this.calcF10(X2, Y + num12 * num6);
              num14 = this.calcF10(X2, Y + num13 * num6);
              num15 = this.calcF10(x0, Y + num14 * num5);
              break;
            case 13:
              num12 = this.calcF13(X1, Y);
              num13 = this.calcF13(X2, Y + num12 * num6);
              num14 = this.calcF13(X2, Y + num13 * num6);
              num15 = this.calcF13(x0, Y + num14 * num5);
              break;
          }
          num4 = Y + num7 * (num12 + 2.0 * (num13 + num14) + num15);
          if (num9 == num8)
          {
            num9 = 0;
            ++num10;

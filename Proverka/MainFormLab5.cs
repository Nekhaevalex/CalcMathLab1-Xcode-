...
namespace Proverka
{
  ...
  public class MainFormLab5 : Form
  {
    ...
    private void Calculate()
    {
      ...
      objArray4[index2] = (object) local3;
      object[] Arguments1 = objArray3;
      // ISSUE: variable of the null type
      __Null local4 = null;
      object objectValue1 = RuntimeHelpers.GetObjectValue(NewLateBinding.LateIndexGet((object) uv, Arguments1, (string[]) local4));
      ...
      object obj1 = NewLateBinding.LateGet((object) local2, Type1, MemberName1, Arguments2, (string[]) local5, (System.Type[]) local6, CopyBack1);
      if (flagArray1[0])
      ...
      int num3 = 2;
      int lk = this.calc.LK;
      for (int index3 = num3; index3 <= lk; ++index3)
      {
        // ISSUE: variable of a boxed type
        __Boxed<double> local7 = (ValueType) dbl_in;
        // ISSUE: variable of the null type
        __Null local8 = null;
        ...
        object Right = NewLateBinding.LateGet((object) local8, Type2, MemberName2, Arguments3, (string[]) local9, (System.Type[]) local10, CopyBack2);
        if (flagArray2[0])
        ...
        int num4 = 0;
        if (Operators.ConditionalCompareObjectLess((object) local7, Right, num4 != 0))
        {
          // ISSUE: variable of the null type
          __Null local11 = null;
          ...
          object obj2 = NewLateBinding.LateGet((object) local11, Type3, MemberName3, Arguments4, (string[]) local12, (System.Type[]) local13, CopyBack3);
          if (flagArray3[0])
      ...
      int num5 = 1;
      int num6 = 0;
      while (num5 <= this.calc.LK)
      {
        this.Otvet.Columns.Add(num6.ToString() + " ", -2, HorizontalAlignment.Left);

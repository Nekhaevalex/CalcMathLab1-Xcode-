...
namespace Proverka
{
  public class NumericLab4
  {
    ...
    private void AnaliticSolver1()
    {
      ...
      int num = 1;
      int lk = this.LK;
      for (int index = num; index <= lk; ++index)
      {
    ...
    private void AnaliticSolver3()
    {
      ...
      int num16 = 1;
      int lk = this.LK;
      for (int index = num16; index <= lk; ++index)
      {
        double num17 = (double) (index - 1) * this.H;
        if (num17 - this.X0 <= 0.0)
          NewLateBinding.LateIndexSet((object) this.UA, new object[2]
          {
            (object) index,
            (object) (num13 * Math.Exp(num1 * num17) + num12 * Math.Exp(-num1 * num17) + num2)
          }, (string[]) null);
        else
          NewLateBinding.LateIndexSet((object) this.UA, new object[2]
          {
            (object) index,
            (object) (num14 * Math.Exp(num3 * num17) + num15 * Math.Exp(-num3 * num17) + num4)
          }, (string[]) null);
      }
    }
    ...
    private void NumSolver1()
    {
      ...
      int num3 = 1;
      int n1 = this.N;
      for (int index = num3; index <= n1; ++index)
      {
      ...
      double Xin1 = 0.0;
      double Xin2 = 0.0;
      double num4 = this.H * this.H;
      double Xin3 = Xin1 + this.H / 2.0;
      double num5 = this.L1FKN(Xin2);
      double num6 = this.L1FKN(Xin2);
      double num7 = this.L1FKN2(Xin2);
      double num8 = this.L1FKN2(Xin2);
      double num9 = num6 + this.B1 * this.H;
      ...
      double num10 = num8 + this.B1 * this.H;
      ...
      {
        (object) 2,
        (object) (this.BM1 * this.H / num10)
      }, (string[]) null);
      int num11 = 3;
      int n2 = this.N;
      for (int index = num11; index <= n2; ++index)
      {
        Xin1 += this.H;
        Xin3 += this.H;
        double num12 = num5;
        num5 = this.L1FKN(Xin3);
        double num13 = Conversions.ToDouble(Operators.SubtractObject((object) (num5 + num12 + this.L1FQN(Xin1) * num4), Operators.MultiplyObject((object) num12, NewLateBinding.LateIndexGet((object) instance1, new object[1]
        {
          (object) (index - 1)
        }, (string[]) null))));
        NewLateBinding.LateIndexSet((object) instance1, new object[2]
        ...
        {
          (object) index,
          Operators.DivideObject(Operators.AddObject((object) (this.L1FN(Xin1) * num4), Operators.MultiplyObject(NewLateBinding.LateIndexGet((object) instance2, new object[1]
          {
            (object) (index - 1)
          }, (string[]) null), (object) num12)), (object) num13)
        }, (string[]) null);
        double num14 = num7;
        num7 = this.L1FKN2(Xin3);
        double num15 = Conversions.ToDouble(Operators.SubtractObject((object) (num7 + num14 + this.L1FQN2(Xin1) * num4), Operators.MultiplyObject((object) num14, NewLateBinding.LateIndexGet((object) instance3, new object[1]
        {
          (object) (index - 1)
        }, (string[]) null))));
        NewLateBinding.LateIndexSet((object) instance3, new object[2]
        ...
        {
          (object) index,
          Operators.DivideObject(Operators.AddObject((object) (this.L1FN2(Xin1) * num4), Operators.MultiplyObject(NewLateBinding.LateIndexGet((object) instance4, new object[1]
          {
            (object) (index - 1)
          }, (string[]) null), (object) num14)), (object) num15)
        }, (string[]) null);
      }
      NewLateBinding.LateIndexSet((object) this.X, new object[2]
      {
      ...
      double num16 = this.L1FKN(Conversions.ToDouble(NewLateBinding.LateIndexGet((object) this.X, new object[1]
      {
        (object) this.N
      }, (string[]) null)));
      ...
      {
        (object) this.N,
        Operators.DivideObject(Operators.AddObject(Operators.MultiplyObject((object) num16, NewLateBinding.LateIndexGet((object) instance2, new object[1]
        {
          (object) this.N
        }, (string[]) null)), (object) (this.BM2 * this.H)), Operators.AddObject(Operators.MultiplyObject((object) num16, Operators.SubtractObject((object) 1, NewLateBinding.LateIndexGet((object) instance1, new object[1]
        {
          (object) this.N
        }, (string[]) null))), (object) (this.B2 * this.H)))
      }, (string[]) null);
      double num17 = this.L1FKN2(Conversions.ToDouble(NewLateBinding.LateIndexGet((object) this.X, new object[1]
      {
        (object) this.N
      }, (string[]) null)));
      ...
      {
        (object) this.N,
        Operators.DivideObject(Operators.AddObject(Operators.MultiplyObject((object) num17, NewLateBinding.LateIndexGet((object) instance4, new object[1]
        {
          (object) this.N
        }, (string[]) null)), (object) (this.BM2 * this.H)), Operators.AddObject(Operators.MultiplyObject((object) num17, Operators.SubtractObject((object) 1, NewLateBinding.LateIndexGet((object) instance3, new object[1]
        {
          (object) this.N
        }, (string[]) null))), (object) (this.B2 * this.H)))
      }, (string[]) null);
    ...
    private void NumSolver2(int Mode)
    {
      ...
      int num7 = 4;
      int n1 = this.N;
      for (int index = num7; index <= n1; ++index)
      {
        h += this.H;
        NewLateBinding.LateIndexSet((object) this.X, new object[2]
        {
        ...
        double num9 = Conversions.ToDouble(Operators.SubtractObject((object) (num4 + num8 + this.L2FQN(Mode, h) * num3), Operators.MultiplyObject((object) num8, NewLateBinding.LateIndexGet((object) instance1, new object[1]
        {
          (object) (index - 1)
        }, (string[]) null))));
        NewLateBinding.LateIndexSet((object) instance1, new object[2]
      ...
      double num12 = this.L2FKN(Mode, Conversions.ToDouble(Operators.AddObject(NewLateBinding.LateIndexGet((object) this.X, new object[1]
      {
        (object) num1
      }, (string[]) null), (object) (this.H / 2.0))));
      double num13 = this.L2FKN(Mode, Conversions.ToDouble(Operators.AddObject(NewLateBinding.LateIndexGet((object) this.X, new object[1]
      {
        (object) 1
      }, (string[]) null), (object) (this.H / 2.0))));
      double num14 = Conversions.ToDouble(Operators.DivideObject(Operators.AddObject(Operators.AddObject((object) (this.L2FN(Mode, Xin1) * num3), Operators.MultiplyObject((object) num12, NewLateBinding.LateIndexGet((object) instance6, new object[1]
      {
        (object) num1
      }, (string[]) null))), Operators.MultiplyObject((object) num13, NewLateBinding.LateIndexGet((object) instance6, new object[1]
      {
        (object) 2
      }, (string[]) null))), Operators.SubtractObject(Operators.SubtractObject((object) (num13 + num12 + this.L2FQN(Mode, Xin1) * num3), Operators.MultiplyObject((object) num12, NewLateBinding.LateIndexGet((object) instance5, new object[1]
      {
        (object) num1
      }, (string[]) null))), Operators.MultiplyObject((object) num13, NewLateBinding.LateIndexGet((object) instance5, new object[1]
      {
        (object) 2
      }, (string[]) null)))));
      if (Mode == 1)
      {
        ...
        for (int index = num8; index <= n2; ++index)
          ...
          {
            (object) index,
            Operators.AddObject(Operators.MultiplyObject((object) num14, NewLateBinding.LateIndexGet((object) instance5, new object[1]
            {
              (object) index
      ...
      int num15 = 2;
      int n3 = this.N;
      for (int index = num15; index <= n3; ++index)
        NewLateBinding.LateIndexSet((object) this.UM, new object[2]
        {
          (object) index,
          Operators.AddObject(Operators.MultiplyObject((object) num14, NewLateBinding.LateIndexGet((object) instance5, new object[1]
    ...
    private void NumSolver3(int Mode)
    {
      ...
      for (int index = num6; index <= num7; ++index)
      {
        ...
        double num10 = Conversions.ToDouble(Operators.AddObject(Operators.AddObject(Operators.AddObject(Operators.MultiplyObject(Operators.NegateObject(NewLateBinding.LateIndexGet((object) instance1, new object[1]
        {
          (object) num8
        }, (string[]) null)), (object) num9), (object) num5), (object) num9), (object) (this.FQN(Mode, Xin1) * num2)));
        NewLateBinding.LateIndexSet((object) instance1, new object[2]
        {
          (object) index,
          (object) (num5 / num10)
        ...
        NewLateBinding.LateIndexSet((object) instance2, new object[2]
        {
          ...
          {
            (object) num8
          }, (string[]) null), (object) num9)), (object) num10)
        }, (string[]) null);
      }
      NewLateBinding.LateIndexSet((object) instance1, new object[2]
      {
      ...
      double num11 = this.FKN(Mode, this.X0);
      double num12 = this.FKN2(Mode, this.X0);
      double num13 = Conversions.ToDouble(Operators.AddObject((object) num12, Operators.MultiplyObject((object) num11, Operators.SubtractObject((object) 1.0, NewLateBinding.LateIndexGet((object) instance1, new object[1]
      {
        (object) num3
      }, (string[]) null)))));
      NewLateBinding.LateIndexSet((object) instance1, new object[2]
      ...
      NewLateBinding.LateIndexSet((object) instance2, new object[2]
      {
        ...
        {
          (object) num3
        }, (string[]) null), (object) num11), (object) num13)
      }, (string[]) null);
      double Xin4 = (double) num4 * this.H;
      double Xin5 = Xin4 + num1;
      double num14 = this.FKN2(Mode, Xin5);
      int num15 = (int) Math.Round(this.L0 + 1.0);
      this.LK1 = this.LK - 1;
      int num16 = num15;
      int lk1_1 = this.LK1;
      for (int index = num16; index <= lk1_1; ++index)
      {
        int num8 = index - 1;
        Xin4 += this.H;
        double Xin3 = Xin4 + num1;
        double num9 = num14;
        num14 = this.FKN2(Mode, Xin3);
        double num10 = Conversions.ToDouble(Operators.SubtractObject((object) (num14 + num9 + this.FQN2(Mode, Xin4) * num2), Operators.MultiplyObject(NewLateBinding.LateIndexGet((object) instance1, new object[1]
        {
          (object) num8
        }, (string[]) null), (object) num9)));
        NewLateBinding.LateIndexSet((object) instance1, new object[2]
        {
          (object) index,
          (object) (num14 / num10)
      ...
      if (Mode == 1)
      {
        ...
        int num8 = 1;
        int lk1_2 = this.LK1;
        for (int index = num8; index <= lk1_2; ++index)
        {
          int num9 = this.LK - index;
          int num10 = num9 + 1;
          NewLateBinding.LateIndexSet((object) this.UM, new object[2]
          {
            (object) num9,
      ...
      int num17 = 1;
      int lk1_3 = this.LK1;
      for (int index = num17; index <= lk1_3; ++index)
      {
        int num8 = this.LK - index;
        int num9 = num8 + 1;
        NewLateBinding.LateIndexSet((object) this.UV, new object[2]
        {
          (object) num8,

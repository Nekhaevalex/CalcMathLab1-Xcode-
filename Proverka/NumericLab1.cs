...
namespace Proverka
{
  public class NumericLab1
  {
    ...
    private void Localization()
    {
      ...
      // ISSUE: variable of the null type
      __Null local3 = null;
      object objectValue1 = RuntimeHelpers.GetObjectValue(NewLateBinding.LateIndexGet((object) z1, Arguments1, (string[]) local3));
      ...
      object obj1 = NewLateBinding.LateGet((object) local1, Type1, MemberName1, Arguments2, (string[]) local4, (Type[]) local5, CopyBack1);
      if (flagArray1[0])
      ...
      do
      {
        ...
        object Right = NewLateBinding.LateGet((object) local7, Type2, MemberName2, Arguments3, (string[]) local8, (Type[]) local9, CopyBack2);
        if (flagArray2[0])
          NewLateBinding.LateIndexSetComplex((object) this.Z, new object[2]
          {
            (object) num4,
        ...
        if (Operators.ConditionalCompareObjectLess(Operators.MultiplyObject((object) local6, Right), (object) 0, false))
        {
          num3 = -num3;
          ++num1;
        }
      ...
      do
      {
        ...
        bool[] flagArray2 = new bool[1]{ true };
        bool[] CopyBack2 = flagArray2;
        object Left = NewLateBinding.LateGet((object) local6, Type2, MemberName2, Arguments3, (string[]) local7, (Type[]) local8, CopyBack2);
        if (flagArray2[0])
          NewLateBinding.LateIndexSetComplex((object) this.Z, new object[2]
          {
            (object) num5,
        ...
        // ISSUE: variable of a boxed type
        __Boxed<double> local9 = (ValueType) 0.0;
        int num7 = 0;
        if (Operators.ConditionalCompareObjectGreater(Left, (object) local9, num7 != 0))
        {
          num6 = num5;
          break;
        }
      ...
      int num8 = 7;
      // ISSUE: variable of a boxed type
      __Boxed<int> local11 = (ValueType) num8;
      objArray10[index4] = (object) local11;
      object[] Arguments4 = objArray9;
      // ISSUE: variable of the null type
      __Null local12 = null;
      object objectValue2 = RuntimeHelpers.GetObjectValue(NewLateBinding.LateIndexGet((object) z2, Arguments4, (string[]) local12));
      objArray8[index3] = objectValue2;
      ...
      object obj2 = NewLateBinding.LateGet((object) local10, Type3, MemberName3, Arguments5, (string[]) local13, (Type[]) local14, CopyBack3);
      if (flagArray3[0])
        NewLateBinding.LateIndexSetComplex((object) this.Z, new object[2]
        {
          (object) num8,
      ...
      double num9 = Conversions.ToDouble(obj2);
      double num10 = num9;
      for (int index5 = num6 + 1; index5 <= 6; ++index5)
      {
        // ISSUE: variable of the null type
        __Null local6 = null;
        Type Type2 = typeof (Math);
        ...
        bool[] flagArray2 = new bool[1]{ true };
        bool[] CopyBack2 = flagArray2;
        object obj3 = NewLateBinding.LateGet((object) local6, Type2, MemberName2, Arguments3, (string[]) local7, (Type[]) local8, CopyBack2);
        if (flagArray2[0])
          NewLateBinding.LateIndexSetComplex((object) this.Z, new object[2]
          {
            (object) index5,
        ...
        double num7 = Conversions.ToDouble(obj3);
        if (num9 < num7)
          num9 = num7;
      }
      // ISSUE: variable of the null type
      ...
      object obj4 = NewLateBinding.LateGet((object) local15, Type4, MemberName4, Arguments6, (string[]) local16, (Type[]) local17, CopyBack4);
      if (flagArray4[0])
        NewLateBinding.LateIndexSetComplex((object) this.Z, new object[2]
        {
          (object) num6,
      ...
      double num13 = num10 / (num10 + num11);
      double num14 = 1.0 + num9 / num12;
      this.NK = 0;
      double X = num13;
    ...
    private void FinalSolution()
    {
      switch (this.varNo)
      {
        case 1:
          int num1 = 1;
          int nk1 = this.NK;
          for (int index = num1; index <= nk1; ++index)
          {
        ...
        case 3:
          int num3 = 1;
          int nk3 = this.NK;
          for (int index = num3; index <= nk3; ++index)
          {
            this.Y = Conversions.ToDouble(NewLateBinding.LateIndexGet((object) this.roots, new object[1]
            {
              (object) index
        ...
        case 4:
          ...
          int num4 = 1;
          int nk4 = this.NK;
          for (int index = num4; index <= nk4; ++index)
          {
            this.Y = Conversions.ToDouble(NewLateBinding.LateIndexGet((object) this.roots, new object[1]
            {
              (object) index

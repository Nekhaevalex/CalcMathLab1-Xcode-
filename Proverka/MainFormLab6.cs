    ...
    private void Calculate()
    {
      ...
      switch (this.varNo)
      {
        case 1:
          ...
          objArray4[index2] = (object) local2;
          object[] Arguments1 = objArray3;
          // ISSUE: variable of the null type
          __Null local3 = null;
          object objectValue1 = RuntimeHelpers.GetObjectValue(NewLateBinding.LateIndexGet((object) uv1, Arguments1, (string[]) local3));
          objArray2[index1] = objectValue1;
          ...
          object obj1 = NewLateBinding.LateGet((object) local1, Type1, MemberName1, Arguments2, (string[]) local4, (System.Type[]) local5, CopyBack1);
          if (flagArray1[0])
          ...
          for (int index3 = num2; index3 <= lk1; ++index3)
          {
            // ISSUE: variable of a boxed type
            __Boxed<double> local6 = (ValueType) dbl_in1;
            // ISSUE: variable of the null type
            __Null local7 = null;
            System.Type Type2 = typeof (Math);
            string MemberName2 = "Abs";
            ...
            object Right = NewLateBinding.LateGet((object) local7, Type2, MemberName2, Arguments3, (string[]) local8, (System.Type[]) local9, CopyBack2);
            if (flagArray2[0])
            ...
            int num3 = 0;
            if (Operators.ConditionalCompareObjectLess((object) local6, Right, num3 != 0))
            {
              // ISSUE: variable of the null type
              __Null local10 = null;
              System.Type Type3 = typeof (Math);
              string MemberName3 = "Abs";
              ...
              objArray10[index5] = objectValue3;
              ...
              object obj2 = NewLateBinding.LateGet((object) local10, Type3, MemberName3, Arguments4, (string[]) local11, (System.Type[]) local12, CopyBack3);
              if (flagArray3[0])
          ...
          int num4 = 1;
          int num5 = 0;
          while (num4 <= this.calc.LK)
          {
            this.Otvet.Columns.Add(num5.ToString() + " ", -2, HorizontalAlignment.Left);
        ...
        case 2:
          ...
          int num6 = 1;
          // ISSUE: variable of a boxed type
          __Boxed<int> local14 = (ValueType) num6;
          objArray15[index7] = (object) local14;
          object[] objArray16 = objArray14;
          int index8 = 1;
          int num7 = 1;
          // ISSUE: variable of a boxed type
          __Boxed<int> local15 = (ValueType) num7;
          objArray16[index8] = (object) local15;
          object[] Arguments5 = objArray14;
          // ISSUE: variable of the null type
          __Null local16 = null;
          object objectValue4 = RuntimeHelpers.GetObjectValue(NewLateBinding.LateIndexGet((object) uv2, Arguments5, (string[]) local16));
          objArray13[index6] = objectValue4;
          ...
          object obj3 = NewLateBinding.LateGet((object) local13, Type4, MemberName4, Arguments6, (string[]) local17, (System.Type[]) local18, CopyBack4);
          if (flagArray4[0])
          ...
          for (int index3 = num8; index3 <= mk1; ++index3)
          {
            int num3 = 1;
            int lk2 = this.calc.LK;
            for (int index4 = num3; index4 <= lk2; ++index4)
            {
              // ISSUE: variable of a boxed type
              __Boxed<double> local6 = (ValueType) dbl_in2;
              // ISSUE: variable of the null type
              __Null local7 = null;
              System.Type Type2 = typeof (Math);
              string MemberName2 = "Abs";
              ...
              int num9 = 0;
              if (Operators.ConditionalCompareObjectLess((object) local6, Right, num9 != 0))
              {
                // ISSUE: variable of the null type
                __Null local10 = null;
                System.Type Type3 = typeof (Math);
                ...
                objArray10[index9] = objectValue3;
                object[] objArray11 = objArray9;
                object[] Arguments4 = objArray11;
                // ISSUE: variable of the null type
                __Null local11 = null;
          ...
          int num10 = 1;
          int num11 = this.calc.LK + 1;
          int lj1 = this.calc.LJ;
          int num12 = num11;
          int num13 = num10;
          while ((lj1 >> 31 ^ num13) <= (lj1 >> 31 ^ num12))
          {
            this.Otvet.Columns.Add("", -2, HorizontalAlignment.Left);
            listViewItem6.SubItems.Add(this.ut.MyDblToStr(this.calc.R0 + this.calc.HX * (double) (num13 - 1)));
            num13 += lj1;
          }
          ...
          int num15 = mk2;
          int num16 = num14;
          while ((lj2 >> 31 ^ num16) <= (lj2 >> 31 ^ num15))
          {
            ListViewItem listViewItem7 = new ListViewItem(this.ut.MyDblToStr(this.calc.Q0 + this.calc.HY * (double) (num16 - 1)));
            int num3 = 1;
            int lk2 = this.calc.LK;
            int lj3 = this.calc.LJ;
            int num9 = lk2;
            int num17 = num3;
            while ((lj3 >> 31 ^ num17) <= (lj3 >> 31 ^ num9))
            {
          ...
          int num19 = lk3;
          int num20 = num18;
          while ((lj4 >> 31 ^ num20) <= (lj4 >> 31 ^ num19))
          {
            listViewItem8.SubItems.Add(this.ut.MyDblToStr(this.calc.R0 + this.calc.HX * (double) (num20 - 1)));
            num20 += lj4;
          }
          ...
          int num22 = mk3;
          int num23 = num21;
          while ((lj5 >> 31 ^ num23) <= (lj5 >> 31 ^ num22))
          {
            ListViewItem listViewItem7 = new ListViewItem(this.ut.MyDblToStr(this.calc.Q0 + this.calc.HY * (double) (num23 - 1)));
            int num3 = 1;
            int lk2 = this.calc.LK;
            int lj3 = this.calc.LJ;
            int num9 = lk2;
          ...
          int num25 = lk4;
          int num26 = num24;
          while ((lj6 >> 31 ^ num26) <= (lj6 >> 31 ^ num25))
          {
            listViewItem9.SubItems.Add(this.ut.MyDblToStr(this.calc.R0 + this.calc.HX * (double) (num26 - 1)));
            num26 += lj6;
          }
          ...
          int num28 = mk4;
          int num29 = num27;
          while ((lj7 >> 31 ^ num29) <= (lj7 >> 31 ^ num28))
          {
            ListViewItem listViewItem7 = new ListViewItem(this.ut.MyDblToStr(this.calc.Q0 + this.calc.HY * (double) (num29 - 1)));
            int num3 = 1;
            int lk2 = this.calc.LK;
            int lj3 = this.calc.LJ;
            int num9 = lk2;
